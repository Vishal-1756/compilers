...
${dt.version}
${config_1.default.owner ? "Owner: " + config_1.default.owner : "Devloper: Free Source"}
...
`, dt.jcmp);
    ...
    let minf = `bot owner ${config_1.default.owner ? config_1.default.owner : "Open Source"}
